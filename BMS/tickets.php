...
switch ($_GET[action]) {
	case "":
	$sqlofviewtickets="SELECT * FROM `tickets` WHERE `u_name` = '$_SESSION[member_name]' && `tid` = '0' ORDER BY `id` DESC";
...
$dddd="<table><tr><td><a href=?action=newticket><img border=0 src=images/newticket.gif></a></td></tr></table>";
$dddd.=$viewticketsvar;
echo $dddd;
}
...
$ssss="<table><tr><td><a href=?action=reply&tid=$_GET[tid]><img border=0 src=images/reply.gif></a></td></tr></table>";
