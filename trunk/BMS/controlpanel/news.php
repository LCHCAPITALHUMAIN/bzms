...
case "addaccept":
$sqlsql="INSERT INTO `news` ( `id` , `date` , `title` , `txt` )
...
$sqlsql3="SELECT * FROM `news` WHERE `id` = '$_GET[id]'";
...
$sqlsql4="UPDATE `news` SET `title` = '$_POST[title]',
...
$delsql="DELETE FROM `news` WHERE `id` = '$_GET[id]'";
