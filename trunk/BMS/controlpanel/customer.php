...
{
case "addform":
$filepath="$sitemainpath/templates/$_SESSION[site_style]/cp/customer.html";
...
case "addaccept":
$sqlsql="INSERT INTO `customers` ( `id` , `image` , `title` , `url` )
...
$sqlsql3="SELECT * FROM `customers` WHERE `id` = '$_GET[id]'";
$queryquery3=$forms->makesql($sqlsql3);
$rowrow3=mysql_fetch_array($queryquery3);
$filepath3="$sitemainpath/templates/$_SESSION[site_style]/cp/customer.html";
...
$sqlsql4="UPDATE `customers` SET `title` = '$_POST[title]',
...
$delsql="DELETE FROM `customers` WHERE `id` = '$_GET[id]'";
...
case "show":
$sqlofshow="SELECT * FROM `customers`";
